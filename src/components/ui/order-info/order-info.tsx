...
import { OrderInformationUIProps } from './type';
import { OrderStatus } from '@components';

export const OrderInformationUI: FC<OrderInformationUIProps> = memo(
  ({ OrderInformation }) => (
    <div className={styles.wrap}>
      ...
      <ul className={`${styles.list} mb-8`}>
        {Object.values(OrderInformation.ingredientsInfo).map((item, index) => (
