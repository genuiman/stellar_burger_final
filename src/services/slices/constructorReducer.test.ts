...
describe('Тест действий конструктора', () => {
  ...
  test('Тест действия добавления ингредиента', () => {
    const ingredient = {
  ...
  test('Тест действия удаления ингредиента', () => {
  ...
  describe('Тест действий изменения порядка ингредиентов', () => {
    test('Тест действия перемещения ингредиента вверх', () => {
      const ingredientId = 1;
      const endState: constructorState = JSON.parse(JSON.stringify(startState));
      [
    ...
    test('Тест действия перемещения ингредиента вниз', () => {
