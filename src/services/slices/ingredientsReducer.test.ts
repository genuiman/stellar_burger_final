...
describe('Тесты действий ингредиентов', () => {
  describe('Тесты действия получения ингридиентов', () => {
    test('Тест действия ожидания ответ после запроса ингредиентов', () => {
    ...
    test('Тест действия ошибки после запроса ингредиентов', () => {
      const store = setupStore();
    ...
    test('Тест действия успешного ответа получения ингредиентов', () => {
      const mockedPayload = {
